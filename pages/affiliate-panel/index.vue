  ...
  <div class="p-2">
    ...
    <div class="cards flex justify-between py-2 text-center">
      <div class="card information border-2 w-[240px] h-[160px] rounded-[9px] py-3 gap-2.5 rounded-[6px] bg-[#F2F5F7]">
        ...
        <div class="Income border-t pt-2.5 flex justify-around text-sm">
          <span class="text-[#7D7D7D]">درآمد:</span>
          <span>12600000 تومان</span>
        </div>
      </div>
    ...
    <div class="mainBox flex justify-between">
      <div class="activeCounter text-center overflow-hidden h-[250px] border rounded-[9px] w-[49%]">
        <div class="pt-7 pb-8 h-[100px] px-5 bg-[#FFCE47]">
          <h1>تعداد کل ثبت‌نام های فعال</h1>
          <div>( فعال برای دریافت پورسانت )</div>
        </div>
    ...
    <div
      ...
      <div class="item flex item-center flex-col gap-8 border-l-2 border-[#D9D9D9] w-[460px]">
        ...
        <span class="copy text-[#0A65CD]">کپی لینک</span>
      </div>
      <div class="item flex item-center flex-col gap-8 border-l-2 border-[#D9D9D9] w-[460px]">
        <h1 class="text-[20px]">کد دعوت (معرف)</h1>
        <nuxt-link class="text-[18px]">userSEG-4587</nuxt-link>
        <span class="copy text-[#0A65CD]">کپی کد</span>
      </div>
      <div class="item flex item-center flex-col gap-[22px] w-[460px]">
        <h1 class="text-[20px]">لینک دعوت</h1>
        <p>نمونه بنر های آماده برای تبلیغات و بارگذاری در وبسایت
          خودتان را میتوانید از لینک زیر مشاهده کنید:</p>
        <span class="copy text-[#0A65CD]">مشاهده</span>
      </div>
          ...
          <template v-slot:content>
            <div class="parent flex flex-col">
              ...
              <div class="content flex flex-col">
                <div
                  class="tr flex justify-between h-[50px] text-[14px] text-[#7D7D7D] border-1 border-b-[#D9D9D9] border-b text-center">
                  <div class="flex w-full px-4">
                    <div class="th title w-[33%] border-1 border-l-[#D9D9D9] border-l pt-[16px]">یک ماهه</div>
                    <span class="w-[33%] border-1 border-l-[#D9D9D9] border-l pt-[16px] text-[#002145]">610 خرید</span>
                    <span class="w-[33%] pt-[16px] text-[#002145]">2.000.000 تومان</span>
                  </div>
                </div>
                <div
                  class="tr flex justify-between h-[50px] text-[14px] text-[#7D7D7D] border-1 border-b-[#D9D9D9] border-b text-center">
                  <div class="flex w-full px-4">
                    <div class="th title w-[33%] border-1 border-l-[#D9D9D9] border-l pt-[16px]">سه ماهه</div>
                    <span class="w-[33%] border-1 border-l-[#D9D9D9] border-l pt-[16px] text-[#002145]">610 خرید</span>
                    <span class="w-[33%] pt-[16px] text-[#002145]">2.000.000 تومان</span>
                  </div>
                </div>
                <div
                  class="tr flex justify-between h-[50px] text-[14px] text-[#7D7D7D] border-1 border-b-[#D9D9D9] border-b text-center">
                  <div class="flex w-full px-4">
                    <div class="th title w-[33%] border-1 border-l-[#D9D9D9] border-l pt-[16px]">شش ماهه</div>
                    <span class="w-[33%] border-1 border-l-[#D9D9D9] border-l pt-[16px] text-[#002145]">610 خرید</span>
                    <span class="w-[33%] pt-[16px] text-[#002145]">2.000.000 تومان</span>
                  </div>
                </div>
                <div
                  class="tr flex justify-between h-[50px] text-[14px] text-[#7D7D7D] border-1 border-b-[#D9D9D9] border-b text-center">
                  <div class="flex w-full px-4">
                    <div class="th title w-[33%] border-1 border-l-[#D9D9D9] border-l pt-[16px]">یک ساله</div>
                    <span class="w-[33%] border-1 border-l-[#D9D9D9] border-l pt-[16px] text-[#002145]">610 خرید</span>
                    <span class="w-[33%] pt-[16px] text-[#002145]">2.000.000 تومان</span>
                  </div>
                </div>
                <div class="tr flex justify-between h-[50px] text-[14px] text-[#7D7D7D]  text-center">
                  <div class="flex w-full px-4">
                    <div class="th title w-[33%] border-1 border-l-[#D9D9D9] border-l pt-[16px] text-[#002145]">تعداد
                      کل
                    </div>
                    <span class="w-[33%] border-1 border-l-[#D9D9D9] border-l pt-[16px] text-[#002145]">610 خرید</span>
                    <span class="w-[33%] pt-[16px] text-[#002145]">2.000.000 تومان</span>
          ...
          <template v-slot:content>
            <div class="parent flex flex-col">
              ...
              <div class="content flex flex-col">
                ...
                <div class="tr flex justify-between h-[50px] text-[14px] text-[#7D7D7D]  text-center">
                  <div class="flex w-full px-4">
                    <div class="th title w-[33%] border-1 border-l-[#D9D9D9] border-l pt-[16px] text-[#002145]">تعداد کل
                    </div>
                    <span class="w-[33%] border-1 border-l-[#D9D9D9] border-l pt-[16px] text-[#002145]">610 خرید</span>
                    <span class="w-[33%] pt-[16px] text-[#002145]">2.000.000 تومان</span>
                  </div>
    ...
    <div
      ...
      <button class="btn-primary text-xs">برداشت موجودی</button>
    </div>
    <div class="rules flex  items-center justify-between bg-[#FCFCFB] border rounded-[10px] py-5 px-2.5 gap-4">
      <div class="flex items-end gap-2.5">
        <h1>مشاهده قوانین و شرایط سیستم همکاری در فروش سگمنتو</h1>
      </div>
      <button class="btn-primary text-xs">مشاهده</button>
    </div>
  </div>
