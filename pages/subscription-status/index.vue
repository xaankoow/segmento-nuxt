<template>
  <div class="w-full h-full rounded-[9px]">
    <div class="w-full h-[51px] bg-base-200 flex items-center text-lg">
      ...
      <div class="flex items-center justify-between w-full h-[40%]">
        ...
        >
          <div class="w-full flex items-center">
            ...
            <p class="mr-3">اشتراک طلایی</p>
          </div>

          <div
            class="w-full h-36 p-4 flex flex-col items-center justify-between"
          >
            <div class="w-full flex items-center text-sm justify-between">
              <p class="text-[10px]">تاریخ خرید اشتراک</p>
              <p>1401/03/02</p>
            </div>
