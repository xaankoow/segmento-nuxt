      ...
      <div class="flex items-center justify-between w-full h-[40%]">
        ...
        >
          ...
          <div class="w-full h-36 px-4 flex flex-col items-center justify-center">
            <ProgressRadial
              :value="auth.full_time"
              :remained="auth.remained_days"
              color="#0A65CD"
              size="8rem"
              fontSize="18px"
              fontSizeText="10px"
              :textValue="`${config.by_route(`${current_page}/charts/remained-day`)}`"
              textColor="#000000"
              :sizeCircle="62"
            ></ProgressRadial>
          </div>
        ...
        >
          ...
          <NuxtLink
            to="/buy-subscription"
            class="w-[168px] h-8 rounded-lg btn-primary text-sm"
          >
        ...
        <div class="w-full h-auto flex flex-wrap justify-between items-center">
          ...
          >
            <div class="w-[70%]">
              ...
              <div class="w-full text-[10px] h-full flex items-center justify-around">
                <div class="flex flex-col items-center justify-center gap-1">
                  ...
                  <div
                    class="bg-base-250 flex items-center justify-center text-xs w-fit px-2 py-[2px] rounded"
                  >
                    <p>{{ limit.budget }}</p>
                  </div>
                </div>
            ...
            <div class="w-[30%] h-full flex items-center justify-center pt-4">
              <ProgressRadial
                :value="limit.budget"
                :remained="limit.remained"
                color="#10CCAE"
                size="5.2rem"
                fontSize="10px"
                fontSizeText="8px"
                :textValue="`${config.by_route(`${current_page}/charts/remained-word`)}`"
                textColor="#000000"
                :sizeCircle="40"
              >
              </ProgressRadial>
