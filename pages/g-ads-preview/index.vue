  ...
  <div class="p-2 flex flex-col">
    <div class="flex flex-row gap-2">
      ...
      <div class="w-full flex flex-row gap-2">
        <div class="flex flex-col justify-between h-full w-full rounded-[3px]">
          ...
          <div class="Desc text-base-content gap-1 flex flex-col">
            ...
            <InputTextArea v-model="site.description.one"
              ...
              class="w-full h-28 -mt-px" :used="(site.description.one.length / 90) * 100"
          ...
          <div class="Desc text-base-content gap-1 flex flex-col">
            ...
            <InputTextArea v-model="site.description.two"
              placeholder="پلتفرم سگمنتو ابزارهای کاملی برای سئو سایت در اختیارتان قرار می‌دهد و پیداکردن کلمات کلیدی برای استراتژی سئو، تولید محتوا، تبلیغات گوگل یا بلاگری را برای شما آسان می‌کند."
              class="w-full h-28 -mt-px" :used="(site.description.two.length / 90) * 100"
      ...
      <div class="flex flex-col gap-1">
        <div class="title gap-1 flex flex-col text-sm text-base-content">
          نحوه نمایش تبلیغ شما در دسکتاپ و موبایل
        </div>
        ...
        <div class="h-full border p-4 rounded-[3px]" dir="ltr">
          ...
          <div class="w-[652px] flex flex-col gap-[5px] text-left">
            ...
            <!-- content -->
            <div class="flex flex-col">
              <div class="flex flex-row h-[35px] text-left text-[20px] text-[#1a0dab] w-[600] overflow-hidden">
                <span dir="rtl" v-if="site.title.one === '' &&
                  site.title.two === '' &&
                  site.title.three === ''
                  ">
              ...
              <div class="h-fit w-[600px] text-[14px] text-left text-[#4d5156] break-words">
                <p dir="rtl" v-if="site.description.one === '' && site.description.two === ''"
        ...
        <div class="flex flex-col justify-center">
          <div class="w-[490px] h-full m-auto relative">
            <div class="flex flex-col gap-[8px] absolute top-[70px] right-[49px]">
              <div
                ...
                <div class="content p-4">
                  ...
                  <div class="w-full flex flex-col text-left">
                    ...
                    <!-- content -->
                    <div class="flex flex-col">
                      <div class="flex flex-row-reverse py-2.5 text-left text-[20px] text-[#1a0dab] w-[600]">
                        <span dir="rtl" v-if="site.title.one === '' &&
                          site.title.two === '' &&
                          site.title.three === ''
                          ">
                      ...
                      <div class="h-fit w-full text-[14px] text-left text-[#4d5156] break-words">
                        <p dir="rtl" v-if="site.description.one === '' && site.description.two === ''
              ...
              <div v-if="site.description.one.length > 0 ||
                  site.description.two.length > 0 ||
                  site.description.two.length > 0 ||
    ...
    <div class="additional bg-base-250 mt-8 text-center px-4 pt-3 rounded-[3px]">
      <span class="w-full text-base-content">
        نیاز به بهترین عنوان‌های گوگل داری؟ می‌تونی از ابزار عنوان‌ساز گوگلی سگمنتو
        استفاده کنی تا بهترین و بهینه‌ترین عناوین رو برای کمپین گوگل ادز استفاده کنی
      </span>
