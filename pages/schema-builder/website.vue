    ...
    <div class="w-full h-auto rounded">
        ...
        <div class="flex justify-start items-start gap-2 w-full h-full p-2" >
            ...
            <div id="inputsCard" class="w-1/2 h-full flex flex-col gap-2 align-start justify-start">
                    ...
                    <div class="w-full" >
                        <InputURL class="w-full align-start" placeholder="آدرس صفحه جستجو داخل سایت" @keyup="changeInternalURL()" v-model="values.target" />
                    </div>
                    <div class="w-full" >
                        <InputURL class="w-full align-start" placeholder="عبارت اضافی برای افزودن به آدرس جست‌وجو (مشابه utm - اختیاری)" @keyup="changeInternalURLString()" v-model="values.targetQuery" />
                    </div>
            </div>
            <!-- _______________________________________ -->
            <!-- left part -->
