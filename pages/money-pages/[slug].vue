  ...
  <div class="flex flex-col w-full h-full">
    ...
    <div class="flex flex-col w-full px-4 gap-5 mt-2 py-2">
              ...
              <div class="border rounded-sm flex flex-col w-10/12">
                <div class="flex flex-row items-center justify-between px-3 py-2">
                  ...
                  <span class="flex flex-row items-center gap-2">
                    <span class="bg-base-350 text-base-500 rounded-full px-3 py-1 text-sm"
                      >9 مورد</span
                    >
                    <span>
                      <svg
      ...
      <div class="flex flex-row items-center justify-end">
        <button
          class="bg-primary/5 px-5 py-2 rounded-lg text-primary hover:bg-primary/10 transition-all duration-150"
        >
