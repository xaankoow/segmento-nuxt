<template xmlns="http://www.w3.org/1999/html">
  <div class="container px-2">
    <div class="notice flex flex-col gap-4">
      ...
      <p class="text-[#7D7D7D]">
        نمونه متن برای نوشتن نکات مهم برای بخش کیف پول میباشد نظیر سقف و کف های برداشت و
        شارژ کیف پول
      </p>
      <p class="text-[#7D7D7D]">
        نمونه متن برای نوشتن نکات مهم برای بخش کیف پول میباشد نظیر سقف و کف های برداشت و
    ...
    <div class="content py-2">
      <span class="flex items-center gap-2.5 p-2.5 w-max">
        <div
          class="circle w-[19px] h-[19px] rounded-[50%] bg-[#0A65CD] flex justify-center items-center"
        >
          <div
            class="child flow-root w-[10px] h-[10px] rounded-[50%] bg-[white] border-solid"
          ></div>
        </div>
        فایل ساز ربات
        <div class="helper">
      ...
      <!--box-->
      <div
        class="boxContent border border-solid border-[#D9D9D9] p-3.5 rounded-[9px] flex gap-8"
      >
        <div class="robots flex flex-col gap-4 w-full relative">
          <h1 class="title flex items-center gap-2.5 pr-[18px] pt-2.5">
            <span
              class="before w-[2px] h-4 rounded-[15px] bg-[#0A65CD] absolute right-[-15px]"
            ></span>
            ...
            <input-select class="border rounded-[2px]">
              ...
              <template v-slot:content>
                <div class="parent flex ltr items-center gap-[7px] w-full flex-col">
                  ...
                  <div class="w-full">
                    <div class="w-max">
                      <input-radio name="rdoRobots"
                        >AdsBot Mobile Web Android</input-radio
                      >
                    </div>
                  </div>
                  <div class="w-full">
          ...
          >
            <span class="flex items-center gap-1 text-[13px]">
              ...
              <span
                class="flow-root text-[13px]"
                v-show="textValue.length > 0 && textValue?.includes('*')"
                >شامل تمامی ربات ها</span
              >
            </span>
            <span class="flex items-center gap-1 text-[13px]">
              <div v-show="textValue.length > 0 && textValue?.includes('$')">
        ...
        <div class="behavior flex flex-col w-full pt-2.5 gap-4 relative">
          <h1 class="title flex items-center gap-2.5">
            <span
              class="before w-[2px] h-4 rounded-[15px] bg-[#0A65CD] absolute right-[-34px]"
            ></span>
          ...
          <div class="combo">
            <input-select class="border rounded-[2px]">
              ...
              <template v-slot:content>
                <div
                  class="parent flex items-center gap-[7px] w-full flex-col cursor-pointer"
                >
                  <div class="w-full">
                    <div class="w-max">
                      <input-radio name="rdoPermission" :value="selectedValue"
                        >مجاز</input-radio
                      >
                    </div>
                  </div>
          ...
          <div class="links">
            <div class="flex flex-col gap-2.5">
              <div class="flex flex-col gap-1">
                <span class="text-[#002145] text-[12px] font-normal px-2.5"
                  >درج لینک</span
                >
                <div class="flex items-center align-center gap-5 relative">
                  ...
                  />
                  <button
                    @click="setItem('ads', 'مجاز', textValue)"
          ...
          >
            <div class="flex flex-col" v-for="item in linkRef">
              ...
              <span>{{
                item.key2 === 1 ? `allow: ${item.value}` : `disAllow: ${item.value}`
              }}</span>
            </div>
          </div>
