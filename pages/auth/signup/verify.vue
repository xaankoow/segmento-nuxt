    ...
    >
      ...
      <div class="flex flex-col justify-between items-center">
        <div class="relative flex flex-col gap-3 items-center mx-auto w-full">
          ...
          >
            <InputText
              class="text-3xl tracking-[1rem] text-center"
              id="number_1"
              type="text"
              maxlength="4"
            />
      ...
      <div
        class="w-[39rem] flex flex-row justify-center gap-4 mt-10 items-center text-sm [&>*]:cursor-pointer"
      >
...
async function resendEmail() {
  let response = await request.post("auth/email/verify/resend", {
