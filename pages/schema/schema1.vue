...
<div class="w-full h-auto rounded">
    ...
    <div class="flex justify-start items-start gap-4 w-full h-full p-7" >
        <div class="w-1/2 h-full flex flex-col gap-10 align-start justify-start" v-for="(value , index) in values" :key="index">
            <div class="w-full " >
                <InputText placeholder="متن نمونه" v-model.trim.lazy="values[index].question" />
            </div>
            <div class="w-full h-full align-start" >
                <InputTextArea class="min-h-[300px]" placeholder="متن نمونه" v-model.trim.lazy="values[index].answer" />
            </div>
        ...
        <div class="w-1/2 flex flex-col gap-10">
            ...
            <div class="w-full h-full" >
                <div class="w-full min-h-[500px]">
                    <SchemaCode :values="values" :jsonData="jsonData" />
                </div>
            </div>
        </div>
