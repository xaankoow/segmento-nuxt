<template>
    <div class="flex flex-col gap-5 w-full h-full">
        ...
        <div class="flex flex-col gap-2 px-2 w-full h-full">
            ...
            <!-- page content -->
            <div class="justify-between gap-4 h-full" :class="data.length === 0 ? 'pb-2' : ''">
                <!-- form -->
                <div class="flex flex-col rounded-md pt-2 border border-base-400"
                    :class="data.length === 0 ? 'h-full' : ''">
                    <!-- header -->
                ...
                <button class="btn-primary mt-2.5 text-white gap-2 px-6" v-if="data.length !== 0"
                ...
                <div class="h-2" v-if="data.length !== 0"></div>
            </div>
        </div>
    </div>
</template>
