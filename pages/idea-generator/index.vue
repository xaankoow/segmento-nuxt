<template>
    <div class="flex flex-col gap-5 w-full h-full">
        ...
        <div class="flex flex-col gap-2 px-2 w-full h-full">
            ...
            <!-- page content -->
            <div class="justify-between w-full pb-2 gap-4 h-full">
                <!-- form -->
                <div class="flex flex-col rounded-md pt-2 border border-base-400"
                    :class="data.length === 0 ? 'h-full' : 'h-auto'">
                    <!-- header -->
                    <div class="flex flex-row justify-between px-2 ">
                        <div class="flex items-center" :class="`${data === null ? 'text-primary-disabled' : ''}`">
                    ...
                    <div class="flex flex-col px-2" v-else>
                        ...
                        <div>
                            <div v-for="(item, index) in data" class="w-full flex flex-row items-center py-3"
                ...
                <button class="btn-primary mt-2.5 text-white gap-2" v-if="data.length !== 0"
