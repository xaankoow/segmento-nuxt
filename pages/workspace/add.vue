    ...
    <Popup class="active" :bubble_bursting="false" v-if="step === 1">
      <template v-slot:header>
        <div class="flex flex-row gap-2 items-center">
          ...
          <span> {{ config.by_route(`${current_page}/title`) }} </span>
          <span>
      ...
      <div class="flex flex-col gap-4 mt-5 w-[50rem] mx-4">
          ...
          <div class="flex flex-col gap-8 w-3/5 px-2 h-full">
            ...
            <div class="flex flex-row items-center gap-4">
              <span class="border-r-2 border-r-primary px-4">{{
                config.by_route(`${steps_section}`)[0].title
              }}</span>
              <span>
            ...
            <p class="px-3 text-justify">
              {{ config.by_route(`${steps_section}`)[0].description }}
            </p>
          </div>
        ...
        <div class="flex flex-row items-center justify-center">
          <button class="btn-secondary flex flex-row items-center gap-3">
            <span>
            ...
            <span>
              {{ config.by_route(`${steps_section}`)[0].add_keyword }}
            </span>
          </button>
        </div>
        <hr />
      ...
      <div class="flex flex-col gap-4 mt-5 w-[50rem] mx-4">
        <div class="flex flex-row">
          ...
          <div class="flex flex-col gap-8 w-3/5 px-2 h-full">
            ...
            <div class="flex flex-row items-center gap-4">
              <span class="border-r-2 border-r-primary px-4">{{
                config.by_route(`${steps_section}`)[1].title
              }}</span>
              <span>
                <svg width="45" height="19" viewBox="0 0 45 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="45" height="19" rx="3" fill="#D9D9D9" />
            ...
            <!-- description -->
            <p class="px-3 text-justify">
              {{ config.by_route(`${steps_section}`)[1].description }}
            </p>
          </div>
        ...
        <div class="flex flex-col-reverse justify-center gap-4 mt-5">
          <div class="flex flex-row items-center gap-8">
            ...
            <button class="btn-secondary flex flex-row items-center justify-center gap-4 px-4" @click="add_page_panel()">
              ...
              <span>
                {{ config.by_route(`${current_page}/steps`)[1].button.add_page }}
              </span>
            </button>
          </div>
          <hr />
