<template>
  <div class="flex flex-col gap-5 w-full h-full">
    ...
    >
      ...
      <div
        class="join rounded-sm bg-base-300 flex flex-row items-center text-base-500 px-1 text-xs"
      >
        <span class="join-item">189</span>
        <span class="join-item border-l border-l-base-500 mx-1 h-[0.7rem]"
          > </span
        >
    ...
    <div class="flex flex-row items-center gap-3 px-2 py-1">
      ...
      <NuxtLink to="/"
        ><TabItem
          :title="config.by_route(`${current_page}/my-list`)"
          :active="false"
      /></NuxtLink>
    </div>
      ...
      <div class="flex flex-row justify-between w-full h-full">
        ...
        <div class="flex justify-center w-2/5">
          <div class="flex flex-col gap-4 items-center w-10/12">
            <!-- drop down disabled -->
            <div
              class="flex flex-row items-center w-full bg-base-400 text-base-500 justify-between rounded-md"
            >
              <span class="w-10/12 px-3 py-2">{{
                config.by_route(`${current_page}/search/word`)
              }}</span>
              <span
                class="w-2/12 border-r border-r-base-500 flex flex-row items-center justify-center h-full"
              >
                <svg
                  width="20"
                  height="12"
