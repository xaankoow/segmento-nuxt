<template>
    ...
    >
      ...
      <div class="flex flex-col w-full p-4 pb-0">
        ...
        <div class="flex flex-col gap-2 items-center text-sm">
          <span class="font-bold">قیمت نهایی برای پرداخت</span>
  ...
  >
    ...
    <div class="flex flex-col gap-5 items-center w-full">
      ...
      <!-- buy button -->
      <button
        class="flex select-none btn-primary"
        @click="show_factor()"
        v-if="form.plan !== null"
      ...
      <!-- footer -->
      <div
        class="flex flex-row items-center w-full justify-between border rounded-md px-7 py-7"
      >
