<template>
  ...
  >
    ...
    <div class="flex flex-col items-center border rounded-md py-2 gap-2">
      ...
      <button
        class="text-primary py-2 px-4 rounded-md bg-base-250 hover:bg-base-300"
      >
        {{ content.detail }}
      </button>
    </div>
    ...
    <div class="flex flex-col gap-5 items-center">
      ...
      <div class="w-full">
        <footer
          class="footer p-4 bg-base-250 rounded-md border text-base-content"
        >
      ...
      <!-- buy button -->
      <button
        class="bg-primary rounded-md py-2 px-3 gap-3 hover:bg-primary-active transition-all duration-75 flex items-center text-base-100"
      >
      ...
      <!-- footer -->
      <div
        class="flex flex-row items-center w-full justify-between border rounded-md px-7 py-3"
      >
        <span class="text-lg"
          >اگر بیزینس هستید یا به امکانات و منابع بیشتری نیاز دارید:
        </span>
        <button
          class="rounded-md text-secondary py-2 px-5 bg-base-250 hover:bg-base-300 transition-all duration-100"
        >
          توضیحات بیشتر
        </button>
      </div>
