  ...
  <div class="w-full h-auto rounded-lg overflow-hidden text-sm">
    <div class="w-full h-full text-base-400 text-sm flex flex-col items-center justify-between p-7">
      ...
      <div id="title_copy_writer_comparisionparentempty"
        ...
        <p>
          {{ config.by_route(`${current_page}/sentences/no-comparision-data`) }}
        </p>
      </div>
      <!-- Comparition Section -->
      ...
      <div id="title_copy_writer_otherparentempty"
        ...
        <p>
          {{ config.by_route(`${current_page}/sentences/no-other-data`) }}
        </p>
      </div>
      <!-- Other Section -->
...
async function creative_copy_writer_request() {
  ...
  document.getElementById('title_copy_writer_comparisionparentempty').style.display = 'none';
  document.getElementById('title_copy_writer_otherparentempty').style.display = 'none';
