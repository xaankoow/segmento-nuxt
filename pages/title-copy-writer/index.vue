    ...
    <div class="w-full h-full text-base-400 text-sm flex flex-col items-center justify-between p-2 gap-2">
      <form @submit.prevent="creative_copy_writer_request()"
        ...
        <input @keypress="clear()" type="text" placeholder="درج کلمه کلیدی" v-model="form.keyword"
          class="w-full h-11 text-black placeholder:text-base-400 border border-base-400 rounded-md text-center" />
        <button class="h-8 rounded-lg btn-primary px-3 py-1">
      ...
      <div id="title_copy_writer_questionparentempty"
        class="w-full h-full bg-base-200 rounded border border-base-400 flex flex-col items-center justify-center gap-3">
        <svg
              width="109"
              height="108"
              viewBox="0 0 109 108"
