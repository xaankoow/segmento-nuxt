...
<template>
  ...
  <div class="w-full min-h-full h-full rounded-[3px] p-2">
    <div class="w-full h-full text-base-400 text-sm flex flex-col items-center justify-start gap-2">
      <div
        class="w-full flex items-center justify-center flex-col gap-2">
        <InputText type="text" placeholder="درج کلمه کلیدی" v-model="form.keyword"
      ...
      _________________________________________ -->
      <div v-if="!showDetailAgreement" class="w-full h-full bg-base-200 rounded-[3px] border border-base-400 flex flex-col items-center justify-center gap-3 p-10">
