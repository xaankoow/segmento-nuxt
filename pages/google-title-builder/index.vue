          ...
          <div class="flex flex-col" v-else>
            ...
            >
              ...
              <div class="flex flex-row w-full items-center">
                <span
                  class="w-[100px] bg-gray-200 text-base-content rounded-[3px] flex justify-center"
                >
                  {{
                    index === "default"
                      ? config.by_route(`${current_page}/table/default`)
                      : index
                  }}
                </span>
              ...
              <div class="flex flex-col">
                ...
                >
                  ...
                  <span class="w-fit flex justify-center items-center pr-3.5 group">
                    <Copy :content="letter" class="[&>svg]:fill-secondary-text flex flex-row gap-2 items-center">
...
function copy_all_content(results) {
  ...
  Object.keys(results).forEach((letter) => {
    content.push(letter !== "default" ? `${letter}:` : "تصادفی:" , ...results[letter], "");
  });
  return content;
}
